(function() {
  ...
  require(["ace/ace", "ace/ext/language_tools"], function(ace, langTools) {
    ...
    addPage = function(tabId, pageURL, pageTitle) {
      ...
      html += '<div class="panel-group page-object" id="page-object-' + (pages.length - 1) + '"> <div class="panel panel-default"> <div class="panel-heading" role="tab" id="headingOne"> <div class="panel-title"> <a data-toggle="collapse" data-parent="" href="#elements-0" aria-expanded="true" aria-controls="collapseOne"> #' + pages.length + ' Page Name </a> <a href="#" class="pull-right"> <i class="fa fa-close remove-button remove-page-button"></i> </a> </div> </div> <div id="elements-' + (pages.length - 1) + '" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne"> <div class="panel-body"> <ul class="elements"></ul> </div> </div> </div> </div>';
      console.log(html);
